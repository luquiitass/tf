...
class PDF{
    ...
    protected function render(){
        ...
        $height = $canvas->get_height() - 15;
        $width = $canvas->get_width() - 85;
//
//        //$canvas->page_text($width,$height, "Página 000 de 000", $this->config->get('dompdf.defines.DOMPDF_DEFAULT_FONT'), 10, array(0, 0, 0));
        $canvas->page_text($width,$height, "Página {PAGE_NUM} de {PAGE_COUNT}", $this->config->get('dompdf.defines.DOMPDF_DEFAULT_FONT'), 10, array(0, 0, 0));
